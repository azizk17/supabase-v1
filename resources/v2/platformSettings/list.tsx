...
export const PlatformSettingList: React.FC<IResourceComponentsProps> = () => {
  ...
  const columns: Array<Column> = React.useMemo(
    () => [
      {
        id: 'platform_name',
        Header: t('platformSetting:fields.platformName', 'Platform name'),
        accessor: 'platform_name',
        Cell: ({ value }) => (value ? value.toLocaleString() : '')
      },
      {
        id: 'created_at',
        Header: t('platformSetting:fields.createdAt', 'Created at'),
        accessor: 'created_at',
        Cell: ({ value }) => (value ? value.toLocaleString() : '')
      },
      {
        id: 'updated_at',
        Header: t('platformSetting:fields.updatedAt', 'Updated at'),
        accessor: 'updated_at',
        Cell: ({ value }) => (value ? value.toLocaleString() : '')
      },
  ...
  return (
    ...
    >
      <Table
        title={t('platformSetting:title', 'platformSettings')}
        columns={columns}
      />
    </Listing>
  );
