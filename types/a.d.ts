...
export type Continent = 'Africa' | 'Antarctica' | 'Asia' | 'Europe' | 'Oceania' | 'North America' | 'South America';


export type EnumCredentialStatus = 'active' | 'hold' | 'removed';


export type EnumFetchStatus = 'on_progress' | 'success' | 'failed' | 'canceled' | 'paused';
...
export type EnumGenerateVideoStatus = 'on_progress' | 'success' | 'failed' | 'in_queue' | 'canceled' | 'paused' | 'scheduled';
...
export type CollectionsMedia = {
  ...
  */
  collection_id?: integer;
   /**
  * Note:This is a Foreign Key to `sources.id`.<fk table='sources' column='id'/>
  *  
  */
  media_id?: integer;
  created_at?: Date;
...
export type FetchSource = {
  ...
  */
  source_id?: integer;
   /**
  * Note:This is a Foreign Key to `fetchs.id`.<fk table='fetchs' column='id'/>
  *  
  */
  fetch_id?: integer;
  duration?: number;
...
export type GeneratedVideo = {
  ...
  */
  ...
  description?: string;
   /**
  * Note:This is a Foreign Key to `channels.id`.<fk table='channels' column='id'/>
  *  
  */
  channel_id?: string;
   /**
  * Note:This is a Foreign Key to `generates.id`.<fk table='generates' column='id'/>
  *  
  */
  generate_id?: integer;
  metadata?: string;
...
export type Generate = {
  ...
  */
  id: integer;
   /**
  * Note:This is a Foreign Key to `templates.id`.<fk table='templates' column='id'/>
  *  
  */
  template_id?: integer;
  metadata?: string;
...
export type Scene = {
  ...
  */
  ...
  title?: string;
   /**
  * Note:This is a Foreign Key to `clips.id`.<fk table='clips' column='id'/>
  *  
  */
  clip_id?: integer;
  created_at?: Date;
...
export type Source = {
  ...
  */
  platform_name: string;
   /**
  * Some sources required credentials to gain accessNote:This is a Foreign Key to `credentials.id`.<fk table='credentials' column='id'/>
  *  
  */
  credential_id?: string;
  created_at?: Date;
